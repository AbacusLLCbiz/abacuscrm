                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          {client.phone && (
                            <a
                              ...
                              className="inline-flex items-center gap-1.5 rounded-md bg-[#eff6ff] border border-[#bfdbfe] px-2.5 py-1 text-xs font-medium text-[#1e40af] hover:bg-[#dbeafe] transition-colors w-fit"
                            >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          <Button variant="ghost" size="icon" className="h-7 w-7" asChild>
                            <Link href={`/clients/${client.id}`}><Eye className="h-3.5 w-3.5" /></Link>
                          </Button>
